function [Cl_alpha, Nb, roh, Mioh, N, NN, K, k_br, Rotor_Solidity, Up_root_Pitch, H, del_pitch, rpm, C_root, taper_ratio, R, R_cut_factor] = userinput(Cl_alpha, Nb, roh, Mioh, N, NN, K, k_br, Rotor_Solidity, Up_root_Pitch, H, del_pitch, rpm, C_root, taper_ratio, R, R_cut_factor)
...
Mioh = 0.0000181206                                                        % Dynamic viscosity  kg/m/s
end